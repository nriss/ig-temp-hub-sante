...
* callerContact 1..1 LM_Contact "Contact appelant" "Coordonnées de l'appelant (canal, type, URI)."

* callbackContact 0..1 LM_Contact "Contact de rappel" "Coordonnées de rappel si différentes du contact appelant."

* detailedName 0..1 LM_DetailedName "Nom de l'appelant" "Prénom et nom de l'appelant."

* type 0..1 code "Type d'appelant" "Qualité ou type de l'appelant."
* type from VS_CallerType (required)
...
* communication from VS_CallerCommunication (required)
