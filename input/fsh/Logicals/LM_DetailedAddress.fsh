...
* wayName 0..1 LM_WayName "Nom de voie" "Nom structuré de la voie."

* highway 0..1 LM_Highway "Voie routière" "Informations sur la voie routière (pour les interventions sur route)."
